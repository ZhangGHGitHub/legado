...
- **AI 阅读伴侣**：引入大模型交互能力，可以跟AI聊聊剧情了。支持工具调用（Function Calling），AI可操作书架、书源、订阅等数据。
...
- AI 阅读伴侣新增工具调用功能：AI 可通过 Function Calling 调用 APP 内置方法，支持查询书架、搜索书籍、查看书源/订阅源、获取阅读统计、查看章节目录等操作（Phase 1 只读阶段）。
